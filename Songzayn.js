...
import './App.css';
import { audios8 } from './AudioData8';
import Player8 from './components/Player8';
import AudioFiles8 from './components/AudioFiles8';
...
function Songzayn() {
  const [songs, setSongs]= useState(audios8);        
  ...
  const nextSong = () => {
    ...
    setCurrentSong(audios8[CurrentIndex + 1])
  }
