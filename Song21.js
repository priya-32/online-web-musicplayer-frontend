...
import AudioFiles21 from './components/AudioFiles21';
import Player21 from './components/Player21';
import { audios21 } from './AudioData21';
function Song21() {
  const [songs, setSongs]= useState(audios21);
  ...
  const nextSong = () => {
    ...
    setCurrentSong(audios21[CurrentIndex + 1])
  }
