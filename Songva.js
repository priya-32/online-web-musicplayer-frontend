...
import './App.css';
import AudioFiles15 from './components/Audiofiles15';
import { audios15 } from './AudioData15';
import Player15 from './components/Player15';
...
function Songva() {
  const [songs, setSongs]= useState(audios15);        
  ...
  const nextSong = () => {
    ...
    setCurrentSong(audios15[CurrentIndex + 1])
  }
