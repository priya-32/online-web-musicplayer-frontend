...
import './App.css';
import { audios10 } from './AudioData10';
import Player10 from './components/Player10';
import AudioFiles10 from './components/AudioFiles10';
...
function Songar() {
  const [songs, setSongs]= useState(audios10);        
  ...
  const nextSong = () => {
    ...
    setCurrentSong(audios10[CurrentIndex + 1])
  }
