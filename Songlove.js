...
import './App.css';
import AudioFiles18 from './components/AudioFiles18';
import { audios18 } from './AudioData18';
import Player18 from './components/Player18';
...
function Songlove() {
  const [songs, setSongs]= useState(audios18);
  ...
  const nextSong = () => {
    ...
    setCurrentSong(audios18[CurrentIndex + 1])
  }
