...
import AudioFiles27 from './components/AudioFiles27';
import Player27 from './components/Player27';
import { audios27 } from './AudioData27';
function Song27() {
  const [songs, setSongs]= useState(audios27);
  ...
  const nextSong = () => {
    ...
    setCurrentSong(audios27[CurrentIndex + 1])
  }
