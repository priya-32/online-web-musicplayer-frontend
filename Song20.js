...
import { audios20 } from './AudioData20';
import Player20 from './components/Player20';
import AudioFiles20 from './components/AudioFiles20';
function Song20() {
  const [songs, setSongs]= useState(audios20);
  ...
  const nextSong = () => {
    ...
    setCurrentSong(audios20[CurrentIndex + 1])
  }
