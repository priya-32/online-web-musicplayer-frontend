...
import AudioFiles26 from './components/AudioFiles26';
import Player26 from './components/Player26';
import { audios26 } from './AudioData26';
function Song26() {
  const [songs, setSongs]= useState(audios26);
  ...
  const nextSong = () => {
    ...
    setCurrentSong(audios26[CurrentIndex + 1])
  }
