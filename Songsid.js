...
import './App.css';
import { audios9 } from './AudioData9';
import Player9 from './components/Player9';
import AudioFiles9 from './components/AudioFiles9';
...
function Songsid() {
  const [songs, setSongs]= useState(audios9);        
  ...
  const nextSong = () => {
    ...
    setCurrentSong(audios9[CurrentIndex + 1])
  }
