...
import { audios13 } from './AudioData13';
import AudioFiles13 from './components/AudioFiles13';
import Player13 from './components/Player13';
...
function Songbts() {
  const [songs, setSongs]= useState(audios13);        
  ...
  const nextSong = () => {
    ...
    setCurrentSong(audios13[CurrentIndex + 1])
  }
