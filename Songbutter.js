...
import { audios17 } from './AudioData17';
import AudioFiles17 from './components/AudioFiles17';
import Player17 from './components/Player17';
...
function Songbutter() {
  const [songs, setSongs]= useState(audios17);        
  ...
  const nextSong = () => {
    ...
    setCurrentSong(audios17[CurrentIndex + 1])
  }
