...
import './App.css';
import { audios3 } from './AudioData3';
import Player3 from './components/Player3';
import AudioFiles3 from './components/AudioFiles3';
...
function Songspb() {
  const [songs, setSongs]= useState(audios3);        
  ...
  const nextSong = () => {
    ...
    setCurrentSong(audios3[CurrentIndex + 1])
  }
