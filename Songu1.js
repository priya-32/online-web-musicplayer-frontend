...
import './App.css';
import { audios11 } from './AudioData11';
import Player11 from './components/Player11';
import AudioFiles11 from './components/AudioFiles11';
...
function Songu1() {
  const [songs, setSongs]= useState(audios11);        
  ...
  const nextSong = () => {
    ...
    setCurrentSong(audios11[CurrentIndex+1 ])
