...
import './App.css';
import AudioFiles12 from './components/AudioFiles12';
import Player12 from './components/Player12';
import { audios12 } from './AudioData12';
...
function Songilai() {
  const [songs, setSongs]= useState(audios12);        
  ...
  const nextSong = () => {
    ...
    setCurrentSong(audios12[CurrentIndex + 1])
  }
