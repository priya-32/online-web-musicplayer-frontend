...
import './App.css';
import { audios1 } from './AudioData1'
import Player1 from './components/Player1';
import AudioFiles1 from './components/AudioFiles1';
...
function Song() {
  ...
  const [songs, setSongs]= useState(audios1);
  ...
  const nextSong = () => {
    ...
    setCurrentSong(audios1[CurrentIndex + 1])
  }
