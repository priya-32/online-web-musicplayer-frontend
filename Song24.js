...
import AudioFiles24 from './components/AudioFiles24';
import Player24 from './components/Player24';
import { audios24 } from './AudioData24';
function Song24() {
  const [songs, setSongs]= useState(audios24);
  ...
  const nextSong = () => {
    ...
    setCurrentSong(audios24[CurrentIndex + 1])
  }
