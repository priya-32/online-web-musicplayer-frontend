...
import AudioFiles25 from './components/AudioFiles25';
import Player25 from './components/Player25';
import { audios25 } from './AudioData25';
function Song25() {
  const [songs, setSongs]= useState(audios25);
  ...
  const nextSong = () => {
    ...
    setCurrentSong(audios25[CurrentIndex + 1])
  }
