...
import './App.css';
import { audios6 } from './AudioData6';
import Player6 from './components/Player6';
import AudioFiles6 from './components/AudioFiles6';
...
function Songjustin() {
  const [songs, setSongs]= useState(audios6);        
  ...
  const nextSong = () => {
    ...
    setCurrentSong(audios6[CurrentIndex + 1])
  }
