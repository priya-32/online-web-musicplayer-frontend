...
import { audios14 } from './AudioData14';
import AudioFiles14 from './components/AudioFiles14';
import Player14 from './components/Player14';
...
function Songselena() {
  const [songs, setSongs]= useState(audios14);
  ...
  const nextSong = () => {
    ...
    setCurrentSong(audios14[CurrentIndex + 1])
  }
