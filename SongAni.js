...
import './App.css';
import { audios2 } from './AudioData2';   
import Player2 from './components/Player2';
import AudioFiles2 from './components/AudioFiles2';
...
function SongAni() {
  const [songs, setSongs]= useState(audios2);        
  ...
  const nextSong = () => {
    ...
    setCurrentSong(audios2[CurrentIndex + 1])
  }
