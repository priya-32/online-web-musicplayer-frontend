...
import AudioFiles28 from './components/AudioFiles28';
import Player28 from './components/Player28';
import { audios28 } from './AudioData28';
function Song28() {
  const [songs, setSongs]= useState(audios28);
  ...
  const nextSong = () => {
    ...
    setCurrentSong(audios28[CurrentIndex + 1])
  }
