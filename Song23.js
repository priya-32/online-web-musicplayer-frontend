...
import Player23 from './components/Player23';
import { audios23 } from './AudioData23';
import AudioFiles23 from './components/AudioFiles23';
function Song23() {
  const [songs, setSongs]= useState(audios23);
  ...
  const nextSong = () => {
    ...
    setCurrentSong(audios23[CurrentIndex + 1])
  }
