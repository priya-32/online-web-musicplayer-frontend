...
import AudioFiles22 from './components/AudioFiles22';
import Player22 from './components/Player22';
import { audios22 } from './AudioData22';
function Song22() {
  const [songs, setSongs]= useState(audios22);
  ...
  const nextSong = () => {
    ...
    setCurrentSong(audios22[CurrentIndex + 1])
  }
