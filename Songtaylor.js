...
import './App.css';
import { audios5 } from './AudioData5';
import Player5 from './components/Player5';
import AudioFiles5 from './components/AudioFiles5';
...
function Songtaylor() {
  const [songs, setSongs]= useState(audios5);        
  ...
  const nextSong = () => {
    ...
    setCurrentSong(audios5[CurrentIndex + 1])
  }
